    ...
    return (
        <>
            ...
            <section className="relative min-h-[90vh] flex items-center bg-white dark:bg-[#0F1112] overflow-hidden">
                <img
                    src="/images/hero/delhi-hero.webp"
                    alt=""
                    ...
                    <div className="relative max-w-5xl">
                        ...
                        <div className="relative glass-card rounded-3xl p-8 md:p-12 lg:p-16 !bg-[#F4F5F6]/70 dark:!bg-[#1A1B1C]/70 backdrop-blur-md">
                            ...
                            <motion.div variants={containerVariants} initial="hidden" animate="visible">
                                <motion.div variants={fadeUp}>
                                    <div className="inline-flex items-center gap-2.5 bg-[#C39A2B]/10 border border-[#C39A2B]/20 rounded-full px-5 py-2.5 mb-8 animate-glow-pulse">
                                        ...
                                        <span className="text-sm font-medium text-paragraph tracking-wide">
                                            Premium Digital Marketing Agency in Delhi
                                        </span>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    Delhi&apos;s South Delhi, Okhla, and Naraina corridors are home to legacy crorepati traders ready for digital transformation, and premium D2C brands whose Meta Ads ROAS is bleeding dry. We build{' '}
                                    <span className="font-semibold text-heading">high-margin retention architectures, brand authority systems, and independent enterprise lead engines</span>{' '}
                                    that prove revenue — not promise it.
                                </motion.p>
