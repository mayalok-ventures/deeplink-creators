                    ...
                    <div className="relative max-w-5xl">
                        ...
                        <div className="relative glass-card rounded-3xl p-8 md:p-12 lg:p-16">
                            ...
                            <motion.div variants={containerVariants} initial="hidden" animate="visible">
                                <motion.div variants={fadeUp}>
                                    <div className="inline-flex items-center gap-2.5 bg-[#C39A2B]/10 border border-[#C39A2B]/20 rounded-full px-5 py-2.5 mb-8 animate-glow-pulse">
                                        ...
                                        <span className="text-sm font-medium text-paragraph tracking-wide">
                                            Premium Digital Marketing Agency in Noida
                                        </span>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    <span className="text-heading">Scaling Noida&apos;s </span>
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#B87A14] to-[#E0C27A]">
                                        Tech, SaaS &amp; B2B Enterprises
                                    </span>
                                    <br />
                                    <span className="text-heading">With Revenue-Engineered </span>
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#B87A14] to-[#E0C27A]">
                                        Growth Systems.
                                    </span>
                                </motion.h1>
                                ...
                                >
                                    Noida&apos;s Sector 62, 125, 132, and 142 are packed with IT companies and SaaS startups — but their CAC is sky-high because cheap agencies burn budgets on Google Ads without a single SQL. We engineer{' '}
                                    <span className="font-semibold text-heading">predictable demo pipelines, enterprise MRR systems, and B2B acquisition architectures</span>{' '}
                                    that turn ad spend into qualified revenue.
                                </motion.p>
