...
export const metadata: Metadata = {
    title: 'Digital Marketing Blog & Results | SEO Tips & Case Studies | Deeplink Creators',
    ...
    openGraph: {
        title: 'Blog & Results | SEO Tips & Case Studies | Deeplink Creators',
    ...
    twitter: {
        ...
        title: 'Blog & Results | Deeplink Creators',
