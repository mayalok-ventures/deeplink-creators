...
export default function SpotSection() {
    return (
        <section className="py-16 bg-white dark:bg-[#0F1112] relative overflow-hidden">
            ...
            >
                <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-white dark:from-[#0F1112] to-transparent z-10 pointer-events-none" />
                <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-white dark:from-[#0F1112] to-transparent z-10 pointer-events-none" />
