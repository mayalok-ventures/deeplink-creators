        ...
        return (
            <div className="min-h-screen bg-[#0F1112] flex items-center justify-center p-4">
                <div className="w-full max-w-md">
                    <div className="bg-[#1A1B1C] border border-white/[0.08] rounded-2xl p-8">
                        <div className="text-center mb-8">
                            <div className="w-16 h-16 bg-primary-500/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                <Shield className="text-primary-400" size={32} />
                            </div>
                            <h1 className="text-2xl font-bold font-heading text-white">Admin Access</h1>
                            <p className="text-white/50 text-sm mt-2">Enter your password to continue</p>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-12 py-3 bg-[#0F1112]/80 border border-white/[0.08] rounded-lg text-white placeholder-white/30 focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500/50 transition-colors"
